...
export const RELATED_CARDS_DATA: {
	...
	[CardIds.GoosePortrait]: [CardIds.TheGoldenizerToken_BG26_813t],
	[CardIds.BottleSticker]: [CardIds.PortalInABottle_BGDUO_113],
	[CardIds.OrcestraPortrait]: [CardIds.OrcEstraConductor_BGDUO_119],
	[CardIds.PromoPortrait]: [CardIds.PrizedPromoDrake_BG21_014],
	[CardIds.SurprisePortrait]: [CardIds.ElementalOfSurprise_BG26_175],
	[CardIds.MechaJaraxxusSticker]: [
		CardIds.MechaJaraxxus_BaltharakToken,
		CardIds.MechaJaraxxus_RustedReggieToken,
		CardIds.MechaJaraxxus_MagtheridonPrimeToken,
	],
	[CardIds.PrimalfinPortrait]: [CardIds.PrimalfinLookout_BGS_020],
	[CardIds.PreviousPearl]: [CardIds.PreciousPearlToken],
	[CardIds.FlagbearerPortrait]: [CardIds.SkyPirateFlagbearer_BG30_119],
	[CardIds.SurveyorPortrait]: [CardIds.HotAirSurveyor_BG30_121],
	[CardIds.ManipulatorPortrait]: [CardIds.FacelessManipulator_BG_EX1_564],
	[CardIds.RedeemerPortrait]: [CardIds.NalaaTheRedeemer_BG28_551],
